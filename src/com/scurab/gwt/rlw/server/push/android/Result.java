 ...
 * {@link #getErrorCodeName()} returns {@literal null}; otherwise, {@link #getMessageId()} returns
 * {@literal null} and {@link #getErrorCodeName()} returns the code of the error.
 * 
 * <p>
 * There are cases when a request is accept and the message successfully created, but GCM has a
 * canonical registration id for that device. In this case, the server should update the
 * registration id to avoid rejected requests in the future.
 * 
 * <p>
