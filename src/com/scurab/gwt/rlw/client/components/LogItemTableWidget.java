...
import com.scurab.gwt.rlw.client.components.DeviceTableWidget.CustomTextCell;
...
public class LogItemTableWidget extends DynamicTableWidget {
    ...
    private ActionCell<HashMap<String,Object>> getActionCell(){
        ActionCell<HashMap<String,Object>> ac = new ActionCell<HashMap<String,Object>>(RemoteLogWeb.WORDS.Download(), new Delegate<HashMap<String,Object>>() {
            @Override
